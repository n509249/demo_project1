...
###       Lambda Variables         ###
######################################
function_name      = "perf-Customer-demoproject_search"
...
env_variables = {
  ...
  CONFIG_TABLE_NAME     = "perf-Customer-demoproject_search-configuration"
  ERROR_TABLE_NAME      = "perf-Customer-demoproject_search-error_codes"
  ERROR_TEXT_TABLE_NAME = "perf-Customer-demoproject_search-error_texts"
  LogResponse           = "true"
  REGION                = "eu-west-1"
}
layers                    = ["perf-aws-services-sdk-layer-jars","perf-thirdparty-frameworks-layer-jars-1", "perf-thirdparty-frameworks-layer-jars-2","perf-ba-internal-framework-layer-jars"]
...
######################################
dynamodb = [{
  table_name     = "perf-Customer-demoproject_search-configuration",
  hash_key       = "KEY",
  hash_key_type  = "S",
  range_key      = "",
  range_key_type = "",
  ...
  table_name     = "perf-Customer-demoproject_search-error_codes",
  ...
  table_name     = "perf-Customer-demoproject_search-error_texts",
  hash_key       = "ERROR_CODE",
  hash_key_type  = "S",
  range_key      = "",
  range_key_type = "",
...
###          IAM Variables         ###
######################################
iam_role_name               = "perf-lambda_iam_role-Demoproject-prl-batch"
iam_policy_name             = "perf-lambda_iam_policy-Demoproject-prl-batch"
...
//If KMS is not available for your siterface. Please remove below variables
######################################
###         KMS Variables          ###
######################################
kms_alias_name = ""
