...
###       Lambda Variables         ###
######################################
function_name      = "uat-Customer-demoproject_search"
...
env_variables = {
  ...
  CONFIG_TABLE_NAME     = "uat-Customer-demoproject_search-configuration"
  ERROR_TABLE_NAME      = "uat-Customer-demoproject_search-error_codes"
  ERROR_TEXT_TABLE_NAME = "uat-Customer-demoproject_search-error_texts"
  LogResponse           = "true"
  REGION                = "eu-west-1"
}
layers                    = ["uat-aws-services-sdk-layer-jars","uat-thirdparty-frameworks-layer-jars-1", "uat-thirdparty-frameworks-layer-jars-2","uat-ba-internal-framework-layer-jars"]
...
######################################
dynamodb = [{
  table_name     = "uat-Customer-demoproject_search-configuration",
  hash_key       = "KEY",
  hash_key_type  = "S",
  range_key      = "",
  range_key_type = "",
  ...
  table_name     = "uat-Customer-demoproject_search-error_codes",
  ...
  table_name     = "uat-Customer-demoproject_search-error_texts",
  hash_key       = "ERROR_CODE",
  hash_key_type  = "S",
  range_key      = "",
  range_key_type = "",
...
###          IAM Variables         ###
######################################
iam_role_name               = "uat-lambda_iam_role-Demoproject-prl-batch"
iam_policy_name             = "uat-lambda_iam_policy-Demoproject-prl-batch"
